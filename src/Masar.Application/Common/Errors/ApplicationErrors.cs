...
namespace Masar.Application.Common.Errors;
...
public static class ApplicationErrors
{
    ...
    public static Error StationWorkerNotFound =>
        Error.NotFound("User.StationWorkerNotFound", "Station worker does not exist.");
}